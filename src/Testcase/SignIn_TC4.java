...
public class SignIn_TC4 extends CommonMethods {
	...
	public void VerifyForgotPassword(String TestCase_ID) throws Exception {
		test = extent.createTest("SigninTest", "Sample description");
		login.VerifyForgotPassword(driver, test, TestCase_ID);
